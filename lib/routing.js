...
FlowRouter.route('/recuperar-contrasenia', {
...
FlowRouter.route('/signup/:invitadoId', {
  name: 'registro-invitado',
  action(params, queryParams) {
    BlazeLayout.render('signupInvitado');
  }
});
...
FlowRouter.route('/workflows', {
  action(params, queryParams) {
    BlazeLayout.render('dashboard', {content: "workflows"});
  }
});
...
tareas.route('/workflows/d', {
  action(params, queryParams) {
    BlazeLayout.render('dashboard', {content: "workflowsDeTareas"});
  }
});
...
documentos.route('/', {
  action() {
    BlazeLayout.render('dashboard', {content: 'documentos'});
  }
});
...
// Rutas para el area administrativa de la empresa

let empresa = FlowRouter.group({
    prefix: "/empresa"
});

empresa.route('/administracion', {
  name: 'Empresa.administracion',
  action(params, queryParams) {
    BlazeLayout.render('empresa', {
      contenido: 'loginAdmin'
    });
  }
});

empresa.route('/ventas', {
  name: 'Empresa.ventas',
  action(params, queryParams) {
    BlazeLayout.render('empresa', {
      contenido: 'loginVentas'
    });
  }
});

// Rutas de contacto con la empresa

FlowRouter.route('/contacto', {
  name: 'Contactanos',
  action(params, queryParams) {
    BlazeLayout.render('contacto');
  }
});

FlowRouter.route('/solicitar-demo', {
  name: 'Formulario.solicitar-demo',
  action(params, queryParams) {
    BlazeLayout.render('formularioDemo');
  }
});
